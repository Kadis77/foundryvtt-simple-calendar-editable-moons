...
describe("Note Manager Class Tests", () => {
    ...
    test("Add New Note", async () => {
        ...
        jest.spyOn(tCal, "getDateTime").mockImplementation(() => {
            return { year: 420, month: 0, day: 0, hour: 0, minute: 0, seconds: 0 };
        });
    ...
    test("Order Notes On Day", async () => {
        ...
        await NManager.orderNotesOnDay("asd", [], { year: 420, month: 0, day: 0, hour: 0, minute: 0, seconds: 0 });
        ...
        await NManager.orderNotesOnDay("asd", ["ns2", "ns1"], { year: 420, month: 0, day: 0, hour: 0, minute: 0, seconds: 0 });
